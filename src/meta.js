// Readable clinical names + units for the standard CKD dataset abbreviations.
export const META = {
  ...
  htn:["Hypertension","yes/no"], dm:["Diabetes","yes/no"], cad:["Coronary artery disease","yes/no"],
  appet:["Appetite","good/poor"], pe:["Pedal edema","yes/no"], ane:["Anemia","yes/no"],
};
